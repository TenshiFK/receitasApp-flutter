...
class FavoritosId extends StatefulWidget {
  final ReceitaModel receitaModel;
  const FavoritosId({super.key, required this.receitaModel});

  @override
  State<FavoritosId> createState() => _FavoritosIdState();
}

class _FavoritosIdState extends State<FavoritosId> {
  @override
